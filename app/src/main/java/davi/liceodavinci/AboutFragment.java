...
public class AboutFragment extends Fragment{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        AboutView aboutView1 = AboutBuilder.with(activity)
                ...
                .setBrief("Appassionato di tecnologia e robotica, fan di Caparezza e della caffeina.")
        ...
        AboutView aboutView2 = AboutBuilder.with(activity)
                ...
                .setBrief("Progetto software, entusiasta delle nuove tecnologie ed animale notturno.")
